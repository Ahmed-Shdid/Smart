        ...
        style: TextStyle(fontSize: 24, fontWeight: FontWeight.w400,
          ...
          Padding(
            ...
            child: Row(
              children:
              [
                Text("Pickup address " , style: TextStyle(fontSize: 20,fontWeight: FontWeight.w500,color: Colors.black54),),
          ...
          Padding(
            ...
            child: Row(
              children:
              [
                Text("Delivery Address " , style: TextStyle(fontSize: 20,fontWeight: FontWeight.w500,color: Colors.black54),),
          ...
          Container(
            ...
            }, child: Text(" Next ",style: TextStyle(letterSpacing: 1.4,color: Colors.teal,fontWeight: FontWeight.w600 ,fontSize: 20),
